...
void teclado(unsigned char key, int x, int y) {
  switch(key) {
    ...
    case 'p': glMatrixMode(GL_PROJECTION);
              ...
              zoom= -40; //aqui mandas toda tu escena hasta atrás si trabajas con perspective
			  break;
...
void ajusta(int ancho, int alto) {
	//al no poner proyeccion está por default de -1 a 1 en los 3 ejes
...
int main(int argc, char** argv) {
    glutInitDisplayMode(GLUT_RGB|GLUT_DOUBLE|GLUT_DEPTH); //aqui le aviso a la tarjeta gráfica
